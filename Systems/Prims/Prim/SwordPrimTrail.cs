...
namespace EEMod.Prim
{
    class SwordPrimTrail : PrimTrail
    {
        ...
        public override void PrimStructure(SpriteBatch spriteBatch)
        {
            ...
            {
                float dist = Math.Abs((_points.Count - i) - _counter * 3);

...
namespace EEMod.Items.Weapons.Melee.Yoyos
{
    public class KelpThrowBolt : EEProjectile
    {
        ...
        {
            Texture2D boltTex = ModContent.Request<Texture2D>("EEMod/Particles/MediumCircle");

            Helpers.DrawAdditive(boltTex, Projectile.Center - Main.screenPosition, Color.Goldenrod, 0.2f);
            
            Helpers.DrawAdditive(ModContent.Request<Texture2D>("EEMod/Textures/RadialGradient"), Projectile.Center - Main.screenPosition, Color.Gold, 0.1f);

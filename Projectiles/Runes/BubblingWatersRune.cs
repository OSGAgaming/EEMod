    ...
    public class BubblingWatersRune : EEProjectile
    {
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            if (Projectile.ai[1] > 120)
                spriteBatch.Draw(ModContent.Request<Texture2D>("EEMod/Projectiles/Nice"), Projectile.Center - Main.screenPosition, new Rectangle(0, 0, 174, 174), lightColor * Math.Abs((float)Math.Sin(flash)) * 0.5f * ((255 - Projectile.alpha) / 255), Projectile.rotation + flash, new Vector2(174, 174) / 2, 1, SpriteEffects.None, 0);

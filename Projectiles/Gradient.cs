...
namespace EEMod.Projectiles
{
    public class Gradient : EEProjectile
    {
        ...
        public void pixelPlacmentHours()
        {
            ...
            Main.spriteBatch.Draw(ModContent.Request<Texture2D>("EEMod/Projectiles/Gradient"), Projectile.Center - Main.screenPosition, new Rectangle(0, 0, 200, 100), Color.White * 0.5f * Projectile.ai[0], Projectile.rotation, new Vector2(0, 50), 1, SpriteEffects.None, 0);
            Main.spriteBatch.End();

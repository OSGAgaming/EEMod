...
namespace EEMod.Projectiles
{
    public class Particles : EEProjectile
    {
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            Main.spriteBatch.Draw(ModContent.Request<Texture2D>("EEMod/Projectiles/Particles"), Projectile.Center - Main.screenPosition, null, lightColor * Math.Abs((float)Math.Sin(flash)) * 2, Projectile.rotation + flash, new Vector2(87), Projectile.ai[0], SpriteEffects.None, 0);
            Main.spriteBatch.End();

...
namespace EEMod.UI.States
{
    ...
    public class FishElement : UIImageButton 
    {
        ...
        public Texture2D BorderTexture = ModContent.Request<Texture2D>("EEMod/UI/FishBorder");
        public bool Caught;
        public int MaxSize;
        public int ItemType;
    ...
    {
        public Texture2D OutlineTexture = ModContent.Request<Texture2D>("EEMod/UI/DisplayBorder");
        ...
        public FishDisplay() : base(ModContent.Request<Texture2D>("EEMod/UI/DisplayBorder")) { }
        ...
        protected override void DrawSelf(SpriteBatch spriteBatch)
        {
            ...
            if (ShouldDraw)
            {
                ...
                BackgroundTexture = ModContent.Request<Texture2D>("EEMod/UI/LogDisplayBGs/" + CurrentHabitat.Replace(" ", ""));
                CalculatedStyle dimensions = GetDimensions();

...
namespace EEMod.Seamap.SeamapContent
{
    public partial class Seamap
    {
        ...
        public static void RenderShip()
        {
            ...
            int frameNum = 0;
            Texture2D playerShipTexture = ModContent.Request<Texture2D>("EEMod/Seamap/SeamapAssets/ShipMount");
        ...
        {
            Texture2D texture3 = ModContent.Request<Texture2D>("EEMod/Seamap/SeamapAssets/ShipHelthSheet");
        ...
        static void RenderClouds()
        {
            ...
            for (int i = 0; i < modPlayer.seagulls.Count; i++)
            {
                ...
                element.Draw(ModContent.Request<Texture2D>("EEMod/Seamap/SeamapAssets/Seagull"), 9, 5);
            }
            #endregion
        }
        ...
        {
            EEPlayer eePlayer = Main.LocalPlayer.GetModPlayer<EEPlayer>();
            Texture2D waterTexture = ModContent.Request<Texture2D>("EEMod/Seamap/SeamapAssets/WaterBg");
            ...
            WaterShader.Parameters["noise"].SetValue(ModContent.Request<Texture2D>("EEMod/Textures/Noise/WormNoisePixelated"));
            WaterShader.Parameters["noiseN"].SetValue(ModContent.Request<Texture2D>("EEMod/Textures/Noise/WormNoisePixelated"));
            WaterShader.Parameters["water"].SetValue(ModContent.Request<Texture2D>("EEMod/Textures/WaterShaderLightMap"));
